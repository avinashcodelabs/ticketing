...
class Password {
    ...
    static compare(storedPassword: string, suppliedPassword: string) {
        ...
        const suppliedPasswordHash = scryptSync(suppliedPassword, salt!, 64).toString("hex");  // salt! mean Non-null Assertion - This tells TypeScript: “I know this is not undefined.”
